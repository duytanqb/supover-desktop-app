#!/usr/bin/env python3
"""
Fix missing listing_url and mockup_url for ALL rows in backlog.
"""
...
def update_row(row_id, updates):
    ...
    try:
        ...
        if result.returncode != 0:
            ...
            return False
        # Check if update succeeded by parsing stdout
        if 'spied' in result.stdout:
            return True
        else:
            print(f"  ❌ No spied confirmation: {result.stdout[:100]}")
            return False
