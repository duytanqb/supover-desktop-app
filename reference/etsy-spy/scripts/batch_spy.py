#!/usr/bin/env python3
"""
Batch spy: search multiple keywords, add qualified listings to backlog.
"""
import subprocess, sys, os, json, time

def run_search(keyword, limit=10, stealth=True):
    """Run etsy_search.py with a single keyword, return results."""
...
def add_listing(listing, keyword):
    """Add a single listing to backlog via etsy_add_simple.py."""
...
def main():
    keywords = ["shirt", "mug", "hoodie", "sweater", "tshirt"]
    added_total = 0
